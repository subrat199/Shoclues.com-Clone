import { Container as Reactcontainer } from '@chakra-ui/react'
import {Box as Reactbox} from '@chakra-ui/react'
...
import {
  ...
  export default function Footer() {
    ...
    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Necessitatibus, distinctio. Ullam repellendus maiores velit temporibus! Quaerat officia voluptatum accusamus dolor, magnam nisi a ducimus, suscipit, consequuntur et autem nobis necessitatibus.
    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Modi, culpa blanditiis inventore magnam alias aperiam ipsam ab dignissimos id. Natus sunt in numquam repellat ullam maxime nemo quis accusamus reiciendis?
    Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum iusto nesciunt aut explicabo eum architecto, quisquam sit! Accusamus, velit qui aliquid alias excepturi amet quia dolore, dolores error exercitationem corporis?
    Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem, quo minima. Tempora sed, excepturi, nobis amet error quas veritatis nemo voluptatem laboriosam expedita repellat consequatur, nihil iste quisquam rem impedit.
     </Reactbox>
     </Reactcontainer>
    <Box
        ...
        <Container as={Stack} maxW={'6xl'} py={10}>
          <SimpleGrid columns={{ base: 1, sm: 2, md: 4 }} spacing={8} paddingLeft={40}>
            ...
            <Stack align={'flex-start'}>
              ...
              <Link href={'https://www.facebook.com/login/?privacy_mutation_token=eyJ0eXBlIjowLCJjcmVhdGlvbl90aW1lIjoxNjc0MTg5MjE5LCJjYWxsc2l0ZV9pZCI6Mzc4Mzc1MTU5OTY2NjIxfQ%3D%3D&next=https%3A%2F%2Ffacebook.com%2F100063629306730'}>Facebook</Link>
              <Link href={'https://twitter.com/i/flow/login?input_flow_data=%7B%22requested_variant%22%3A%22eyJsYW5nIjoiZW4ifQ%3D%3D%22%7D'}>Twitter</Link>
        ...
        <Box py={10}>
          ...
          Copyright © 2023 Apple Inc. All rights reserved.Privacy Policy Terms of Use
          </Text>
        </Box>
      </Box>
        </>
